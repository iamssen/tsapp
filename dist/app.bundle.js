...
/***/ function(module, exports, __webpack_require__) {
	...
	var Components_1 = __webpack_require__(230);
	var Store_1 = __webpack_require__(342);
	...
	react_dom_1.render(React.createElement(react_redux_1.Provider, {store: Store_1.store}, React.createElement(react_router_1.Router, {history: react_router_1.browserHistory, onUpdate: onUpdateHook}, React.createElement(react_router_1.Route, {path: "/", component: Components_1.App}, React.createElement(react_router_1.IndexRoute, {component: Components_1.XRoute}), React.createElement(react_router_1.Route, {path: "/github", component: Components_1.Github}), React.createElement(react_router_1.Route, {path: "/jsfiddle", component: Components_1.JsFiddle})))), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions_1 = __webpack_require__(330);
	var Responsive_1 = __webpack_require__(337);
	...
	var AppComponent = (function (_super) {
	    ...
	    AppComponent.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("div", {className: "main-menu"}, React.createElement("nav", {className: "navbar navbar-fixed-top navbar-light bg-faded"}, React.createElement("button", {className: "navbar-toggler hidden-sm-up", type: "button", "data-toggle": "collapse", "data-target": "#navbar"}, "&#9776;"), React.createElement("div", {className: "collapse navbar-toggleable-xs", id: "navbar"}, React.createElement("a", {className: "navbar-brand", href: "#"}, "TSWEB"), React.createElement("ul", {className: "nav navbar-nav"}, React.createElement("li", {className: "nav-item"}, React.createElement(react_router_1.IndexLink, {className: "nav-link", to: "/", activeClassName: "active"}, "Activities")), React.createElement("li", {className: "nav-item"}, React.createElement(react_router_1.Link, {className: "nav-link", to: "/github", activeClassName: "active"}, "Github")), React.createElement("li", {className: "nav-item"}, React.createElement(react_router_1.Link, {className: "nav-link", to: "/jsfiddle", activeClassName: "active"}, "JsFiddle")))))), React.createElement("div", {className: "container main-content"}, this.props.children)));
	    };
	    return AppComponent;
	}(React.Component));
	...
	var ActivitiesComponent = (function (_super) {
	    ...
	    ActivitiesComponent.prototype.render = function () {
	        ...
	        return (React.createElement("div", null, React.createElement(Responsive_1.Responsive, null, React.createElement(Responsive_1.ResponsiveTarget, {size: 10000}, React.createElement("p", null, "MAX")), React.createElement(Responsive_1.ResponsiveTarget, {size: 1200}, React.createElement("p", null, "render 1200")), React.createElement(Responsive_1.ResponsiveTarget, {size: 1000}, React.createElement("p", null, "render 1000")), React.createElement(Responsive_1.ResponsiveTarget, {size: 800}, React.createElement("p", null, "render 800")), React.createElement(Responsive_1.ResponsiveTarget, {size: 600}, React.createElement("p", null, "render 600")), React.createElement(Responsive_1.ResponsiveTarget, {size: 400}, React.createElement("p", null, "render 400")), React.createElement(Responsive_1.ResponsiveTarget, {size: 200}, React.createElement("p", null, "render 200"))), React.createElement("h1", {className: "content-activity"}, "Activities"), React.createElement("div", {className: "content-activity card-columns"}, items)));
	    };
	    ActivitiesComponent.prototype.componentDidMount = function () {
	        var dispatch = this.props.dispatch;
	        dispatch(Actions_1.requestGithubRepositories());
	        dispatch(Actions_1.requestGithubGists());
	        dispatch(Actions_1.requestJsFiddle());
	    };
	    ActivitiesComponent.prototype.shouldComponentUpdate = function (nextProps, nextState, nextContext) {
	        return this.props.activities !== nextProps.activities;
	    };
	    return ActivitiesComponent;
	}(React.Component));
	var GithubComponent = (function (_super) {
	    __extends(GithubComponent, _super);
	    function GithubComponent() {
	        _super.apply(this, arguments);
	    }
	    GithubComponent.prototype.render = function () {
	        var repositories = this.props.githubRepositories.items
	            .map(function (item, i) { return React.createElement("li", {key: i}, item.name); });
	        var gists = this.props.githubGists.items.map(function (item, i) { return React.createElement("li", {key: i}, item.description); });
	        return (React.createElement("div", null, React.createElement("h1", null, "Github Repositories"), React.createElement("ul", null, repositories), React.createElement("h1", null, "Github Gists"), React.createElement("ul", null, gists)));
	    };
	    GithubComponent.prototype.componentDidMount = function () {
	        var dispatch = this.props.dispatch;
	        dispatch(Actions_1.requestGithubRepositories());
	        dispatch(Actions_1.requestGithubGists());
	    };
	    GithubComponent.prototype.shouldComponentUpdate = function (nextProps, nextState, nextContext) {
	        return this.props.githubRepositories !== nextProps.githubRepositories || this.props.githubGists !== nextProps.githubGists;
	    };
	    return GithubComponent;
	}(React.Component));
	var JsFiddleComponent = (function (_super) {
	    __extends(JsFiddleComponent, _super);
	    function JsFiddleComponent() {
	        _super.apply(this, arguments);
	    }
	    JsFiddleComponent.prototype.render = function () {
	        var fiddles = this.props.jsFiddles.items.map(function (item, i) { return React.createElement("li", {key: i}, item.title); });
	        return (React.createElement("div", null, React.createElement("h1", null, "Js Fiddle"), React.createElement("ul", null, fiddles)));
	    };
	    JsFiddleComponent.prototype.componentDidMount = function () {
	        var dispatch = this.props.dispatch;
	        dispatch(Actions_1.requestJsFiddle());
	    };
	    JsFiddleComponent.prototype.shouldComponentUpdate = function (nextProps, nextState, nextContext) {
	        return this.props.jsFiddles !== nextProps.jsFiddles;
	    };
	    return JsFiddleComponent;
	}(React.Component));
	var ConnectedApp = react_redux_1.connect(function (state) { return state; })(AppComponent);
	exports.App = ConnectedApp;
	var ConnectedActivities = react_redux_1.connect(function (state) { return ({
	    dispatch: state.dispatch,
	    activities: state.activities
	}); })(ActivitiesComponent);
	exports.Activities = ConnectedActivities;
	var ConnectedGithub = react_redux_1.connect(function (state) { return ({
	    dispatch: state.dispatch,
	    githubRepositories: state.githubRepositories,
	    githubGists: state.githubGists
	}); })(GithubComponent);
	exports.Github = ConnectedGithub;
	var ConnectedJsFiddle = react_redux_1.connect(function (state) { return ({
	    dispatch: state.dispatch,
	    jsFiddles: state.jsFiddles
	}); })(JsFiddleComponent);
	exports.JsFiddle = ConnectedJsFiddle;
	var XRoute = (function (_super) {
	    __extends(XRoute, _super);
	    function XRoute() {
	        _super.apply(this, arguments);
	    }
	    XRoute.prototype.render = function () {
	        return (React.createElement(ConnectedActivities, null));
	    };
	    return XRoute;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Services = __webpack_require__(331);
	...
	var receiveJsFiddle = function (items) { return ({
	...
	exports.requestJsFiddle = function () { return function (dispatch, getState) {
	    if (needUpdate(getState().jsFiddles)) {
	        Services
	            .getJsFiddles()
	            .then(function (fiddles) { return dispatch(receiveJsFiddle(fiddles)); });
	    }
	}; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(334)('jsonp');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Responsive = (function (_super) {
	    ...
	    Responsive.prototype.render = function () {
	        ...
	        if (!this.state || !this.state.contents)
	            return React.createElement("div", {className: "responsive"});
	        var content = this.state.contents.reduce(function (a, b) {
	            if (a)
	                return a;
	            if (b.size < _this.state.stageWidth)
	                return b;
	        }, null) || this.state.contents[this.state.contents.length - 1];
	        return React.createElement("div", {className: "responsive"}, content.contents);
	    };
	    Responsive.prototype.syncSize = function () {
	        var stageWidth = (document.body) ? document.body.clientWidth : window.innerWidth;
	    ...
	    Responsive.prototype.componentDidMount = function () {
	        ...
	        this.syncSize();
	        this.resizeHandler = function (event) { return _this.syncSize(); };
	    ...
	    Responsive.prototype.shouldComponentUpdate = function (nextProps, nextState, nextContext) {
	...
	var ResponsiveTarget = (function (_super) {
	    __extends(ResponsiveTarget, _super);
	    function ResponsiveTarget() {
	        _super.apply(this, arguments);
	    }
	    ResponsiveTarget.prototype.render = function () {
	        return null;
	    };
	    return ResponsiveTarget;
	}(React.Component));
	exports.ResponsiveTarget = ResponsiveTarget;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var thunkMiddleware = __webpack_require__(343);
	//const createLogger = require('redux-logger');
	var MainReducers = __webpack_require__(344);
	// , createLogger()
	var logger = function (store) { return function (next) { return function (action) {
	    console.log('????', action);
	    return next(action);
	}; }; };
	var store = redux_1.createStore(redux_1.combineReducers(MainReducers), {}, redux_1.applyMiddleware(thunkMiddleware));
	exports.store = store;
	function replaceReducers(SubReducers) {
	    store.replaceReducer(redux_1.combineReducers(Object.assign({}, MainReducers, SubReducers)));
	}
	    ...
	    if (action.type === Actions_1.RECEIVE_GITHUB_REPOSITORIES || action.type === Actions_1.RECEIVE_GITHUB_GISTS || action.type === Actions_1.RECEIVE_JSFIDDLE) {
	        ...
	        switch (action.type) {
	            case Actions_1.RECEIVE_GITHUB_REPOSITORIES:
	                oldItems = state.items.filter(function (item) { return item.from !== 'github'; });
	            ...
	            case Actions_1.RECEIVE_GITHUB_GISTS:
	                oldItems = state.items.filter(function (item) { return item.from !== 'gist'; });
	                newItems = action.items.map(function (item) { return freeze({
	            ...
	            case Actions_1.RECEIVE_JSFIDDLE:
	                oldItems = state.items.filter(function (item) { return item.from !== 'jsfiddle'; });
	                newItems = action.items.map(function (item) { return freeze({
	                    name: item.title,
